...
- Current mobile full-page capture: `qa/implementation-mobile-current.png` (375 × 1302 at 1× density)
...
- The chart preserves the seven-point shape and underlined “Today” marker. Numeric dates are centered directly beneath each point; weekday labels are removed.
...
- Fix: removed weekdays, inset the plot by 24px, and centered each numeric date under its point.
- Post-fix evidence: `qa/implementation-mobile-current.png`; the revised comparison shows compact evidence rows, one privacy statement, a distinct footer, and centered numeric dates without overflow.
